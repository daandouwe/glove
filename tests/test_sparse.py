"""
Test various sparse matrices for speed.
"""
import time
import sys
...
if __name__ == '__main__':
    ...
    construct_test(10, n, m=n, matrix='dok')
    construct_test(10, n, m=n, matrix='lil')
    construct_test(10, n, m=n, matrix='coo')
    construct_test(10, n, m=n, matrix='csc')
    construct_test(10, n, m=n, matrix='csr')
    print()

    print('Testing indexing...')
    index_test_array(100, n)
    index_test('csr', 100, n)
    index_test('csc', 100, n)
    # index_test('dok', 100)
